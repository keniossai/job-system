...
<section id="intro">
    <div class="carousel-item active">
        <div class="carousel-background">
            <img src="imags/slider/slider1.jpg" alt="" />
        </div>
        <div class="carousel-container">
            <div class="carousel-content">
                ...
                <p class="font-color-white">
                    ...
                    praesent fermentum a elit mollis purus aenean curabitur eleifend
                </p>
...
<div id="search-box">
    <div class="container search-box">
        <form action="#" id="search-box_search_form_3"
            ...
            <button type="submit" class="search-box_search_button">
                Search Jobs
            </button>
        </form>
    </div>
...
<section id="Job-Category">
    <div class="container">
        ...
        <p class="max-width">
            Lorem ipsum tempus amet conubia adipiscing fermentum viverra gravida,
            mollis suspendisse pretium dictumst inceptos mattis euismod
        </p>
    ...
    <div class="container text-center">
        ...
        <div class="job-list">
            ...
            <ul class="pagination justify-content-end margin-auto">
                ...
                <li class="page-item">
                    <a class="page-link pdding-none" href="javascript:void(0);">
                        <i class="material-icons keyboard_arrow_left_right">keyboard_arrow_right</i></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-6 align-self-center">
                ...
                <ul>
                    <li class="list-item1">
                        Et vestibulum ullamcorper curae tellus consectetur erat pharetra
                        et cubilia <br />
                        Nibh est auctor lacus nam lacinia aptent
                    </li>
                    <li class="list-item1">
                        Vitae sociosqu a nisi cubilia vulputate aliquam vulputate
                        imperdiet tempor arcu fames
                    </li>
                    <li class="list-item1">
                        Odio habitasse senectus morbi dapibus mauris non primis, nisl
                        ante hendrerit consectetur nulla phasellus eleifend, ad at
                        scelerisque vulputate habitant tempor
                    </li>
                </ul>
                <div class="vertical-space-30"></div>
                ...
                <div class="Clients-Testimonial-item">
                    <div class="testimonial">
                        ...
                        <p class="description">
                            ...
                            vehicula turpis non est imperdiet, et facilisis nisl tempus.
                            Donec nec.
                        </p>
                        <div class="pic">
